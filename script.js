const translations = {
  en: {
    ...
    experience: {
      ...
      title: "Making neural architecture search care about energy.",
      text:
        "At T\u00e9l\u00e9com Paris, I am building BANERA: an automated benchmarking system for studying how neural-network workloads consume energy on real edge hardware.",
      point1: "Remote neural-network benchmarks on edge devices",
      point2: "Automated warm-up, calibration, and measured execution",
      point3: "Adaptive workloads for measurable power traces",
      point4: "Paired raw traces and metadata for later analysis",
  ...
  it: {
    ...
    experience: {
      ...
      title: "Progettare reti neurali tenendo conto del consumo energetico.",
      text:
        "A T\u00e9l\u00e9com Paris sviluppo BANERA, un sistema automatizzato per misurare il consumo energetico dei carichi neurali direttamente sui dispositivi edge.",
      point1: "Prove da remoto di modelli neurali su dispositivi edge",
      point2: "Warm-up, calibrazione ed esecuzione misurata gestiti in automatico",
      point3: "Carichi di lavoro adattivi per ottenere tracce di potenza affidabili",
      point4: "Tracce grezze e metadati raccolti insieme, pronti per l'analisi",
